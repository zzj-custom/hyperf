...
Router::addRoute(['GET', 'POST', 'HEAD'], '/handle-img-curl', 'App\Controller\IndexController@handleImgCurl');
Router::addRoute(['GET', 'POST', 'HEAD'], '/get-image', 'App\Controller\IndexController@getImage');
